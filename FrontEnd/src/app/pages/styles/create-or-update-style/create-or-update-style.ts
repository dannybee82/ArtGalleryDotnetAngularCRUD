...
@Component({
  ...
  templateUrl: './create-or-update-style.html',
  styleUrl: './create-or-update-style.scss',
})
export class CreateOrUpdateStyle implements OnInit {
  ...
  submit(): void {
    if (this.StyleForm.valid) {
      ...
      action$.subscribe(
        this._sharedObserver.getObserver(this.isUpdateMode(), messages, ['/all-styles']),
      );
    } else {
