    ...
    public class MainDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var allImages = DummyDataImagesPart1.Create()
                ...
                .Concat(DummyDataImagesPart6.Create())
                .Concat(DummyDataImagesPart7.Create())
                .Concat(DummyDataImagesPart8.Create())
                .ToList();
            ...
            var allThumbnails = DummyDataThumbnailsPart1.Create()
                ...
                .Concat(DummyDataThumbnailsPart6.Create())
                .Concat(DummyDataThumbnailsPart7.Create())
                .Concat(DummyDataThumbnailsPart8.Create())
                .ToList();
